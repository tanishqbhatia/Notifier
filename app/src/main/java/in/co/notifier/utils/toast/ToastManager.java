...
import static in.co.notifier.utils.toast.ToastBuilder.LENGTH_STICKY;

public class ToastManager extends Handler implements Comparator<ToastBuilder> {
    ...
    /**
     * @return A {@link ToastManager} instance to be used for given {@link Activity}.
     */
